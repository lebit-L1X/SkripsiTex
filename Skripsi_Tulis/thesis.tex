...
\definecolor{stringred}{RGB}{170,0,0}
...
\newlistof{equations}{equ}{Daftar Persamaan}
...
\input{src/00-front_matter/02-penggunaan AI}
%
%
...
\clearpage
\phantomsection
\pdfbookmark[0]{Daftar Algoritma}{algorithms}
\lstlistoflistings
\clearpage
\phantomsection
\pdfbookmark[0]{Daftar Persamaan}{equations}
\listofequations
\clearpage
\phantomsection
...
\cleardoublepage
\phantomsection
\pdfbookmark[0]{Daftar Istilah}{glossary}
...
\nocite{*} % optional but recommended for now
