...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/pics/time_domain.png}
    \caption{Visualisasi Time Domain Sampel Sinyal EEG Sintetis}
    \label{fig:time_domain}
\end{figure}

Kemiripan tersebut juga terlihat pada visualisasi domain waktu dan domain frekuensi pada \ref{fig:time_domain} dan Gambar X.X, di mana sinyal sintetis mampu mengikuti pola amplitudo utama serta distribusi spektral frekuensi dominan dari sinyal asli.
