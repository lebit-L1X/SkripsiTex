...
Penerapan augmentasi pada data EEG memiliki tantangan tersendiri. Berbeda dengan berbagai jenis data multimedia lain seperti citra, audio, atau video yang umumnya memiliki pola representasi yang lebih stabil, sinyal EEG merupakan data \textit{time series} multikanal yang bersifat non-stasioner dan memiliki rasio \textit{signal-to-noise} yang rendah \cite{eeg_da_review} \cite{eeg_generative_review}. Karakteristik tersebut menyebabkan proses manipulasi data EEG tidak dapat dilakukan secara sederhana tanpa berisiko mengubah pola sinyal yang berkaitan dengan aktivitas otak. Metode augmentasi yang umum digunakan pada domain \textit{time series} seperti penambahan \textit{noise}, pergeseran waktu, atau manipulasi amplitudo tidak dapat diterapkan pada data EEG karena berpotensi mengubah karakteristik temporal dan spasial yang penting dalam representasi sinyal \cite{eeg_da_challenges}. 
...
Berdasarkan permasalahan tersebut, penelitian ini bertujuan untuk mengeksplorasi penggunaan teknik data augmentation berbasis Variational Autoencoder (VAE) untuk menghasilkan data EEG sintetis dan menganalisis pengaruhnya terhadap performa model klasifikasi ASD berbasis EEG. Penelitian dilakukan dengan mengimplementasikan pendekatan klasifikasi EEG menggunakan seleksi fitur mRMR dan algoritma XGBoost berdasarkan penelitian rujukan \cite{paper_ref}, kemudian mengevaluasi perbedaan performa model sebelum dan sesudah penerapan data augmentasi.
%-----------------------------------------------------------------------------%%-----------------------------------------------------------------------------%
