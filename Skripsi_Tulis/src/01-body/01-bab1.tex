...
\item \textbf{Metode Augmentasi dan Klasifikasi:} Penelitian ini menerapkan metode \textit{data augmentation} berbasis \textit{Variational Autoencoder} (VAE) untuk menghasilkan data EEG sintetis. Selanjutnya, proses klasifikasi dilakukan menggunakan pendekatan yang mengacu pada penelitian rujukan \cite{paper_ref}, yaitu kombinasi seleksi fitur \textit{mRMR} dan model klasifikasi \textit{XGBoost} serta metode \textit{Deep Neural Network} yang digunakan sebagai baseline pada penelitian rujukan.
