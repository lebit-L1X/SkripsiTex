...
Gambar \ref{fig:dnn_architecture} menunjukkan arsitektur model DNN yang digunakan dalam penelitian ini, yang terdiri dari lapisan input, satu hidden layer dengan 5 neuron, serta lapisan output dengan fungsi aktivasi softmax. Struktur ini digunakan sebagai model klasifikasi berbasis \textit{supervised learning} untuk memetakan fitur EEG yang telah diekstraksi ke dalam kelas target.
